...
urlpatterns = [
    ...
    path('contacts/<int:pk>/individual', contacts_views.individual_contact, name='individual_contact'),
    path('contacts/<int:pk>/notes/', contacts_views.add_contact_note, name='add_contact_note'),
]
